...
export default function TextType<T extends ElementType = "div">({
  ...
  useEffect(() => {
    ...
    const processedText = reverseMode
      ...
      : currentText;
    const targetLen = processedText.length;
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- animation loop state machine
  }, [
    currentCharIndex,
    displayedText,
    isDeleting,
  ...
  const currentLine = textArray[currentTextIndex] ?? "";
  const shouldHideCursor =
    hideCursorWhileTyping &&
    (currentCharIndex < currentLine.length || isDeleting);
